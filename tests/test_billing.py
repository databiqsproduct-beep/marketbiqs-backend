...
class BillingCatalogTests(unittest.TestCase):
    def test_current_plan_prices_and_allowances(self):
        ...
        self.assertEqual(plans["creator"].included_reports, 10)
        self.assertEqual(plans["creator"].included_scrapes, 500)
        self.assertEqual(plans["creator"].included_rivals, 10)
        self.assertIsNone(billing.max_tracked_rivals(agency(PlanType.agency)))
        self.assertEqual(billing.max_tracked_rivals(agency(PlanType.creator)), 10)
